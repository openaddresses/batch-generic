...
import { sql, createPool, createTypeParserPreset, DatabasePool } from 'slonik';
...
export default class Pool {
    ...
    constructor(pool: DatabasePool, connstr: string) {
     ...
     */
    static async connect(postgres: string, opts: ConnectParams): Promise<Pool> {
        if (!opts) opts = {};
     ...
     */
    async schemas(opts: SchemaParams): Schema {
        const res = {
            tables: {},
            views: {}
        };
